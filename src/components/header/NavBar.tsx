...
const NavBar = () => {
  ...
  return (
    <div
      className="px-8 py-2 mx-0 w-full flex shadow justify-between items-center
    "
    >
      <h1 className="w-full text-3xl font-bold text-[#00df9a]">HandCraft</h1>
      <div className="hidden md:block">
        <ul className="flex items-center">
          <div className="flex border-slate-300  border-2 rounded mx-10">
            <input type="text" className="outline-0 w-100  px-4" />
            <button className="bg-[#00df9a] px-4">
      ...
      <h1 className="w-full text-3xl py-2 px-8 font-bold text-[#00df9a]">HandCraft</h1>
        <ul className="p-4">
